...
<div style={{ position: "relative", paddingBottom: "56.25%", height: 0, marginTop: "2rem" }}>
  <iframe
    src="https://www.youtube.com/embed/wOb0cQpxIV4"
...
:::info
A detailed **text-based configuration guide** (including links to the Milesight ToolBox app) is available here:  
https://docs.hardwario.com/milesight/sensors/index#general-configuration
:::